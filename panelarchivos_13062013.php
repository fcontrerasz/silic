...
//$today = date("Y-m-d", strtotime('2013-06-18'));
//echo "hoy es: ".$today." vence -->".$row_rsListarLicitacion['FECHA_TERMINO']." consultas: ".$row_rsListarLicitacion['FECHA_CONSULTAS'];
?>
<?php if(EmpresaPostula($_SESSION['MM_UserID'],$colname_rsListadolix)>0){ ?>
<?php if(($row_rsListarLicitacion['ID_ESTADOLICITA']=="1")){ ?>
<?php //if($today<=$row_rsListarLicitacion['FECHA_CONSULTAS']){ ?>
<?php if($today<=$row_rsListarLicitacion['FECHA_TERMINO']){ ?>
