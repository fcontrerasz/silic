...
var data1 = (parseFloat($("#vcategoria1_"+id).val())*parseFloat($("#vcategoria1").val()))/100;
var data2 = (parseFloat($("#vcategoria2_"+id).val())*parseFloat($("#vcategoria2").val()))/100;
var data3 = (parseFloat($("#vcategoria3_"+id).val())*parseFloat($("#vcategoria3").val()))/100;
