...
<div id="mensajes" title="CREADA"></div>
    ...
    <table class="flexme2">
		...
		do { ?>
            ...
            <td><?php if($today<=$row_rsListarLicitacion['FECHA_CONSULTAS']){ ?><a href="#" id="<?php echo $row_rsListadoArchivos['ID_DOCUMENTACION']; ?>"><img src="img/delete.png" class="deleteme" title="Eliminar" /></a><?php } ?></td>
