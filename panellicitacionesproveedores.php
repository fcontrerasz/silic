...
$altogrilla = 480;
$ocultar = "true";
$filtroempre = "AND ID_LICITACION IN (".licitacionesProveedores($_SESSION['MM_UserID'],$_SESSION['MM_Empresa']).")";
}
...
//echo $query_rsListadoLicitaciones;
...
$(function () {
var hasta = new Date(<?php echo date("Y",strtotime($row_rsListadoLicitaciones['FECHA_CONSULTAS'])); ?>, <?php echo date("m",strtotime($row_rsListadoLicitaciones['FECHA_CONSULTAS'])); ?> -1, <?php echo date("d",strtotime($row_rsListadoLicitaciones['FECHA_CONSULTAS'])); ?>,<?php echo date("H",strtotime($row_rsListadoLicitaciones['FECHA_CONSULTAS'])); ?>,<?php echo date("i",strtotime($row_rsListadoLicitaciones['FECHA_CONSULTAS'])); ?>);
...
colModel : [
						...
						{display: 'Codigo', name : 'code', width : 70, sortable : true, align: 'left'},
						...
						{display: 'Proyecto', name : 'avance', width : 80, sortable : true, align: 'left'},
                        ...
                        {display: 'Activo', name : 'tipo', width : 60, sortable : true, align: 'left'},
						{display: 'Restante para Consultas', name : 'consultas', width : 120, sortable : true, align: 'left'},
						{display: ' ', name : 'modificar', width : 20, sortable : true, align: 'left', process: Editar<?php if(in_array($_SESSION['MM_UserGroup'], array("1","3"))){ ?>, hide: true <?php } ?>},
						{display: ' ', name : 'eliminar', width : 20, sortable : true, align: 'left', <?php if($_SESSION['MM_UserGroup']==2){ ?>process: Listar<?php }else{ ?> process: Revisar<?php } ?> },
						{display: ' ', name : 'archivos', width : 20, sortable : true, align: 'left',   <?php if($_SESSION['MM_UserGroup']==2){ ?>process: Bases<?php }else{ ?> process: Archivos<?php } ?>},
						{display: ' ', name : 'preguntas', width : 42, sortable : true, align: 'left', process: Preguntas<?php if(in_array($_SESSION['MM_UserGroup'], array("3"))){ ?>, hide: true <?php } ?>}
                ],
height:'auto',
sortname: "",
sortorder: "asc",
...
$(window).load(function(){
   <?php echo counterProveedores($_SESSION['MM_UserID']); ?>
});
...
<?php if(in_array($_SESSION['MM_UserGroup'], array("1","3"))){ ?>
$(".panel1").hide();
<?php } ?>
...
$("#btn_cancelafiltro").click(function(){
	location.href = "panellicitacionesproveedores.php";
});
...
<table width="100%" height="1%" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
  ...
  <tr>
    ...
    <td>HORA</td>
    <td><input type="text" name="hora1" id="hora1" class="upper" size="8" />
      <input type="text" name="hora2" id="hora2" class="upper" size="8" /></td>
  </tr>
  <tr>
    <td>DESDE</td>
    <td><input type="text" name="ndesde" id="ndesde" size="20" class="upper" /></td>
    <td>HASTA</td>
    <td><input type="text" name="nhasta" id="nhasta" size="20" class="upper" /></td>
    <td>ESTADO</td>
...
<form id="frm_filtro" action="panellicitacionesproveedores.php" method="get">
<table width="100%" height="1%" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
...
<div id="mensajes" title="CREADA"></div>
    <table class="flexme2">
		...
		do { ?>
            ...
            <tr>
                  <td><?php echo $row_rsListadoLicitaciones['ID_LICITACION']; ?></td>
               ...
               <!-- <td><?php echo date("d/m/Y",strtotime($row_rsListadoLicitaciones['FECHA_CREACION'])); ?></td>-->
                ...
                <td><?php echo date("d/m/Y",strtotime($row_rsListadoLicitaciones['FECHA_TERMINO'])); ?></td>
                  ...
                  <td <?php if($row_rsListadoLicitaciones['ESTADO_LICITA']=="PENDIENTE"){
					...
					echo "style='background-color:#78B537;'";
					} ?>
                  
                  
                  ><?php echo $row_rsListadoLicitaciones['ESTADO_LICITA']; ?></td>	
                  <td><?php echo miEstadoLicita($_SESSION['MM_UserID'],$row_rsListadoLicitaciones['ID_LICITACION'])>0?'<img src="img/star_16.png"  class="editme" title="Postulado" />&nbsp;ACTIVO':""; ?></td>	
                  
                   <td>
				   <?php 
				   //echo $row_rsListadoLicitaciones['FECHA_CONSULTAS'];
				   
				   if(miEstadoLicita($_SESSION['MM_UserID'],$row_rsListadoLicitaciones['ID_LICITACION'])>0){ ?>
				   <span <?php if($row_rsListadoLicitaciones['ESTADO_LICITA']!="VIGENTE"){ ?> style="display:none;" <?php } ?> id="counter<?php echo $row_rsListadoLicitaciones['ID_LICITACION']; ?>"></span>
                   <?php } ?>
</td>
				  ...
				  } ?>" class="editme" title="Postulantes" /></a></td>
                  <td><a href="#" id="<?php echo $row_rsListadoLicitaciones['ID_LICITACION']; ?>"><img src="img/attachment_16.png"  class="editme" title="Archivos Licitacion" /></a></td>
