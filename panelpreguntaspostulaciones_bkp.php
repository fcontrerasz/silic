...
PANEL &gt; LICITACIONES &gt;<a style="text-decoration:underline;" href="panellicitaciones.php">VOLVER A <?php echo nombreLicitacion($colname_rsListadoPostulaciones);?></a>
</div>
    </td>
    </tr>
</table>
 ...
 <tr>
  ...
  <tr id="panel-ingreso-preguntas">
    <td width="10%">RESPUESTA</td>
      <td width="80%"><textarea name="txt_pregunta" id="txt_pregunta" cols="130" rows="3" class="upper"></textarea>
