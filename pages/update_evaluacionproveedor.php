...
$insertSQL = sprintf("CALL `update_evaluacionesprovee`(%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,@result);",
                       GetSQLValueString($_GET['ideval'], "int"),
