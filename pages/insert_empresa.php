...
$insertSQL = sprintf("CALL `insert_empresa`(%s, %s, %s, %s, %s, %s, %s, %s, %s, @result);",
                       GetSQLValueString($_GET['comunas'], "int"),
                       GetSQLValueString($_GET['rubros'], "int"),
                       GetSQLValueString($_GET['region'], "int"),
                       GetSQLValueString($_GET['nombre'], "text"),
                       GetSQLValueString($_GET['rut'], "int"),
                       GetSQLValueString($_GET['dv'], "text"),
					   GetSQLValueString($_GET['fono'], "int"),
                       GetSQLValueString($_GET['dire'], "text"),$_SESSION['MM_UserID']);
